...
func (b *FractionApplyConfiguration) WithNumerator(value uint32) *FractionApplyConfiguration {
	b.Numerator = &value
	return b
}
...
func (b *FractionApplyConfiguration) WithDenominator(value string) *FractionApplyConfiguration {
	b.Denominator = &value
	return b
}
