...
type FilterApplyConfiguration struct {
	Fault *FaultFilterApplyConfiguration `json:"fault,omitempty"`
}
...
func (b *FilterApplyConfiguration) WithFault(value *FaultFilterApplyConfiguration) *FilterApplyConfiguration {
	b.Fault = value
	return b
}
