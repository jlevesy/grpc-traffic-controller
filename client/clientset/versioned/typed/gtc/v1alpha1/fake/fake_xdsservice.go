...
var xdsservicesResource = schema.GroupVersionResource{Group: "api.gtc.dev", Version: "v1alpha1", Resource: "xdsservices"}

var xdsservicesKind = schema.GroupVersionKind{Group: "api.gtc.dev", Version: "v1alpha1", Kind: "XDSService"}
