...
type Refresher interface {
	RefreshCache(ctx context.Context, svcs []kxdsv1alpha1.Service, endpoints map[ktypes.NamespacedName]corev1.Endpoints) error
}
...
func (c *cacheRefresher) RefreshCache(ctx context.Context, svcs []kxdsv1alpha1.Service, k8sEndpoints map[ktypes.NamespacedName]corev1.Endpoints) error {
	var (
